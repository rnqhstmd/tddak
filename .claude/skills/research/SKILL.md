...
name: research
version: 1.0.0
description: "[tddak/TDD 강제] 도메인 리서치. 웹 검색과 문서 분석 병행. /tddak:context 생성 시 외부 자료 조사 품질 향상. ttutak:research와 동일 동작이며 식별 마커만 추가."
...
> **이 스킬**: research — 외부 도메인 리서치
> **혼동 주의**: ttutak:research와 동일 동작. 식별 마커만 추가됨.
> **호출 시 주의**: 이 스킬 내에서 다른 스킬을 호출할 때 반드시 `tddak:` 접두사를 사용한다. (예: `Skill("tddak:context")`)
...
/tddak:context <도메인명> --from .research/{파일명}.md 로 context에 반영할 수 있습니다.
```
